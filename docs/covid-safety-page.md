...
I'll do my best to stay well, but if I am ill, develop Covid symptoms, or test positive for Covid, I will not come to class.  If that happens, here’s what you can expect 
- If I am well enough to teach but are taking precautions to avoid infecting others, I will have a synchronous online session.  If this happens, you will receive an email and an announcement in Canvas telling you how to join the class.  You can anticipate that this would very likely be a last-minute email.  
- Otherwise, I'll try to arrange a substitute or reschedule the class.
